...
def validate_customers(df, engine):
    """
    проверка клиентов
    дубликаты, пропуски обязательных полей, формат почты
    """
    errors = []
...
def validate_orders(df, df_customers, engine):
    """
    проверка заказов
    внешние ключи на customers, отрицательные суммы
    """
    errors = []
...
def validate_payments(df, df_orders, engine):
    """
    проверка платежей
    внешние ключи на orders, отрицательные суммы
    """
    errors = []
